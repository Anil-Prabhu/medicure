node {
    ...
    stage ('code checkout'){
        ...
        git 'https://github.com/Anil-Prabhu/medicure.git'
        }
        catch(Exception e){
            ...
            Thanks,''', subject: 'The jenkis Job ${JOB_NAME} is Failed ', to: 'anilprabhu66@gmail.com'
        }
    }
    ...
    stage('Build the DockerImage of the application'){
        ...
        sh "${dockerCMD} build -t Anil-Prabhu/medicure:${tagName} ."
    ...
    stage('push the docker image to dockerhub'){
        ...
        // some block
        sh "${dockerCMD} login -u anilprabhu -p ${DockerPassword}"
        sh "${dockerCMD} push anilprabhu/medicure:${tagName}"
        }
    }
